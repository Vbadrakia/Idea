...
import { MapPin, DollarSign, Building, ChevronRight, Info, AlertCircle, X, CheckCircle2, Calendar, ListChecks, Clock, Video, TrendingUp, Briefcase, Target } from 'lucide-react';
...
export const CandidateDashboard: React.FC<CandidateDashboardProps> = ({ jobs, applications, onApply, onConfirmInterview, currentUser }) => {
  const [activeTab, setActiveTab] = useState<'jobs' | 'applications' | 'career-map'>('jobs');
